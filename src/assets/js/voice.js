...
const VoiceModule = (() => {
  ...
  function getSpeechLang() {
    ...
    const map = { hi:'hi-IN', mr:'mr-IN', ta:'ta-IN', te:'te-IN', bn:'bn-IN', gu:'gu-IN', kn:'kn-IN', ml:'ml-IN', pa:'pa-IN', en:'en-IN' };
    return map[l] || 'en-IN';
  }
  ...
  function initSpeechRecognition() {
    if ('webkitSpeechRecognition' in window || 'SpeechRecognition' in window) {
      ...
      recognition.onerror = () => {
        stopListening();
        showListeningText('Could not understand. Please try again or click a topic.');
      };
